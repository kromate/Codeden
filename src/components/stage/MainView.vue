	...
	>
		<template #item="{ element, index }">
			<div class="hover:scale-[1.01] hover:mb-2 hover:ring-4 ring-opacity-0 hover:ring-opacity-50 rounded-lg ring-primary transition duration-300 ease transform ">
				...
				<div class="absolute bottom-0 left-0 z-40 px-4 py-2 mb-4 ml-3 text-xs font-medium text-indigo-600 transition duration-150 ease-out bg-white border border-gray-200 rounded-full shadow-lg opacity-0 action">Hero 1</div>
